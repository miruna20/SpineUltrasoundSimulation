...
if __name__ == '__main__':
    ...
    5. Use imfusion workspace file to extract a point cloud from the segmentations --> extract_pcd_from_US_labelmaps.py
    ...
    6. Separate the point cloud of the spine into individual pointclouds of vertebrae. These will be used as partial 
    point clouds for the completion --> separate_spine_pc_into_vertebrae.py
    7. Get a list of all of the lumbar vertebrae for which poinclouds are available 
    8. Combine pairs of complete and incomplete pointclouds in h5 dataset that will be used for the VRCNet for shape completion
    """
    ...
    # if we want to get a partial point cloud with some points from the nearby vertebrae
